...
MCL began as MegaCommand Live for the MegaCommand/MegaCMD hardware platform. The project now targets multiple platforms, so the documentation and user-facing name use **MCL** as the primary project name.
