...
MenuPage midi_config_page(&midiconfig_menu_layout, &config_param1, &config_param2);
MenuPage md_config_page(&mdconfig_menu_layout, &config_param1, &config_param2);
MenuPage mcl_config_page(&mclconfig_menu_layout, &config_param1, &config_param2);
