...
const menu_t<7> seq_menu_layout PROGMEM = {
    "SEQ",
    {
        ...
        {"COPY", 0, 3, 3, (uint8_t *)&opt_trackall, (Page *)NULL, opt_copy_track_handler, { {0, "--",}, {1, "TRK."}, {2, "ALL"}}},
        {"CLEAR", 0, 3, 3, (uint8_t *)&opt_trackall, (Page *)NULL, opt_clear_track_handler, { {0, "--",}, {1, "TRK."}, {2, "ALL"}}},
        {"CLEAR", 0, 0, 3, (uint8_t *)&opt_trackall, (Page *)NULL, opt_clear_locks_handler, { {0, "--",}, {2, "LCKS."}, {2, "ALL"}}},
        {"PASTE", 0, 3, 3, (uint8_t *)&opt_trackall, (Page *)NULL, opt_paste_track_handler, { {0, "--",}, {1, "TRK."}, {2, "ALL"}}},
