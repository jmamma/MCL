...
GUI.setLine(GUI.LINE1);
  ...
  if (encoders[1]->getValue() == 4) {


    if (encoders[1]->hasChanged()) {
      encoders[1]->old = encoders[1]->cur;
      encoders[2]->setValue(cfg.clock_rec);
    }
    ...
    if (encoders[2]->hasChanged()) {
      ...
      cfg.clock_rec = encoders[2]->getValue();
    }
  }
  else if (encoders[1]->getValue() == 5) {


    if (encoders[1]->hasChanged()) {
      encoders[1]->old = encoders[1]->cur;
      encoders[2]->setValue(cfg.clock_send);
    }
    ...
    if (encoders[2]->hasChanged()) {
      ...
      cfg.clock_send = encoders[2]->getValue();
    }
  }
  else if (encoders[1]->getValue() == 2) {

    if (encoders[1]->hasChanged()) {
      encoders[1]->old = encoders[1]->cur;
      encoders[2]->setValue(cfg.uart1_turbo);
    }
    ...
    if (encoders[2]->getValue() == 2) {
      GUI.put_string_at_fill(10, "4x");
    }
    if (encoders[2]->getValue() == 3) {
      GUI.put_string_at_fill(10, "8x");
    }
    if (encoders[2]->hasChanged()) {
      encoders[2]->old = encoders[2]->cur;
      cfg.uart1_turbo = encoders[2]->getValue();
    }

  }

  else if (encoders[1]->getValue() == 3) {

    if (encoders[1]->hasChanged()) {
      encoders[1]->old = encoders[1]->cur;
      encoders[2]->setValue(cfg.uart2_turbo);
    }
    ...
    if (encoders[2]->hasChanged()) {
      encoders[2]->old = encoders[2]->cur;
      cfg.uart2_turbo = encoders[2]->getValue();
    }

  }
  else if (encoders[1]->getValue() == 0) {
