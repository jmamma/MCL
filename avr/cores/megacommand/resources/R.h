...
struct __T_menu_layouts {
  ...
  union {
    ...
    char zz__seq_menu_layout[453];
  };
  static constexpr size_t countof_seq_menu_layout = 453 / sizeof(menu_t<seq_menu_page_N>);
  static constexpr size_t sizeofof_seq_menu_layout = 453;
  union {
