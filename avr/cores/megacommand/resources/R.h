...
struct __T_icons_logo {
  ...
  union {
    ...
    char zz__icon_analog_logo_medium[27];
  };
  static constexpr size_t countof_icon_analog_logo_medium = 27 / sizeof(unsigned char);
  static constexpr size_t sizeofof_icon_analog_logo_medium = 27;
  union {
    unsigned char icon_metronome_logo_medium[0];
    char zz__icon_metronome_logo_medium[24];
  };
  static constexpr size_t countof_icon_metronome_logo_medium = 24 / sizeof(unsigned char);
  static constexpr size_t sizeofof_icon_metronome_logo_medium = 24;
  union {
  ...
  union {
    unsigned char icon_perf_logo_medium[0];
    char zz__icon_perf_logo_medium[27];
  };
  static constexpr size_t countof_icon_perf_logo_medium = 27 / sizeof(unsigned char);
  static constexpr size_t sizeofof_icon_perf_logo_medium = 27;
  union {
    unsigned char icon_mnm_logo_medium[0];
    char zz__icon_mnm_logo_medium[27];
  };
  static constexpr size_t countof_icon_mnm_logo_medium = 27 / sizeof(unsigned char);
  static constexpr size_t sizeofof_icon_mnm_logo_medium = 27;
  union {
    unsigned char icon_midi_logo_medium[0];
    char zz__icon_midi_logo_medium[27];
  };
