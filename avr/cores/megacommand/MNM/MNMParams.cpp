...
const model_param_name_t mnm_gnd_sin_model_names[] PROGMEM = { {"TUN", 7},
							 {"", 127} };
const model_param_name_t mnm_gnd_nois_model_names[] PROGMEM = { {"ST", 0},
							  {"RED", 1},
							  {"TUN", 7},
							  {"", 127} };
const model_param_name_t mnm_swave_saw_model_names[] PROGMEM = { {"UNL", 0},
							   {"UNW", 1},
							   {"UNX", 2},
							   {"SBX", 4},
							   {"SB1", 5},
							   ...
							   {"TUN", 7},
							   {"", 127} };
const model_param_name_t mnm_swave_puls_model_names[] PROGMEM = { {"UNL", 0},
							    {"UNW", 1},
							    {"SB1", 2},
							    {"SB2", 3},
							    {"PW", 4},
							    ...
							    {"TUN", 7},
							    {"", 127} };
const model_param_name_t mnm_swave_ens_model_names[] PROGMEM = { {"PC2", 0},
							   {"PC3", 1},
							   {"PC4", 2},
							   {"WAV", 3},
							   {"PW", 4},
							   ...
							   {"TUN", 7},
							   {"", 127} };
const model_param_name_t mnm_sid_6581_model_names[] PROGMEM = { {"PW", 0},
							  {"PWD", 1},
							  {"PWR", 2},
							  {"WAV", 3},
							  {"MOD", 4},
							  ...
							  {"TUN", 7},
							  {"", 127} };
const model_param_name_t mnm_dpro_wave_model_names[] PROGMEM = { {"WAV", 0},
							   {"WP", 1},
							   {"WPM", 2},
							   {"WPR", 3},
							   {"SYN", 4},
							   ...
							   {"TUN", 7},
							  {"", 127} };
const model_param_name_t mnm_dpro_bbox_model_names[] PROGMEM = { {"PTC", 0},
							   {"STR", 1},
							   {"RTG", 4},
							   {"RTM", 5},
							   {"", 127} };
const model_param_name_t mnm_dpro_ddrw_model_names[] PROGMEM = { {"WV1", 0},
							   {"MIX", 1},
							   {"WV2", 2},
							   {"TIM", 3},
							   {"BR1", 4},
							   ...
							   {"TUN", 7},
							   {"", 127} };
const model_param_name_t mnm_dpro_dens_model_names[] PROGMEM = { {"PC2", 0},
							   {"PC3", 1},
							   {"PC4", 2},
							   {"WAV", 3},
							   {"CHL", 5},
...
const model_param_name_t mnm_fm_stat_model_names[] PROGMEM = { {"1FQ", 0},
							   {"1FI", 1},
							   {"1NV", 2},
							   {"1FB", 3},
							   {"2FQ", 4},
							   ...
							   {"TUN", 7},
							   {"", 127} };
const model_param_name_t mnm_fm_par_model_names[] PROGMEM = { {"1FQ", 0},
							   {"1NV", 1},
							   {"2FQ", 2},
							   {"2NV", 3},
							   {"3FQ", 4},
							   ...
							   {"TUN", 7},
							   {"", 127} };
const model_param_name_t mnm_fm_dyn_model_names[] PROGMEM = { {"1FQ", 0},
							   {"1FN", 1},
							   {"1VL", 2},
							   {"1VN", 3},
							   {"2FQ", 4},
							   ...
							   {"TUN", 7},
							   {"", 127} };
const model_param_name_t mnm_vo_vo6_model_names[] PROGMEM = { {"VC1", 0},
							   {"VC2", 1},
							   {"VSW", 2},
							   {"VOI", 3},
							   {"CNS", 4},
							   ...
							   {"TUN", 7},
							   {"", 127} };
const model_param_name_t mnm_fx_thru_model_names[] PROGMEM = {   {"INP", 7},
							   {"", 127} };
const model_param_name_t mnm_fx_reverb_model_names[] PROGMEM = { {"DEC", 0},
							   {"DMP", 1},
							   {"GAT", 2},
							   {"MIX", 3},
							   {"HP", 4},
							   ...
							   {"INP", 7},
							   {"", 127} };
const model_param_name_t mnm_fx_chorus_model_names[] PROGMEM = { {"DEL", 0},
							   {"DEP", 1},
							   {"SPD", 2},
							   {"MIX", 3},
							   {"FB", 4},
							   ...
							   {"INP", 7},
							   {"", 127} };
const model_param_name_t mnm_fx_dynamix_model_names[] PROGMEM = { {"ATK", 0},
							   {"REL", 1},
							   {"THR", 2},
							   {"MIX", 3},
							   {"RAT", 4},
							   ...
							   {"INP", 7},
							   {"", 127} };
const model_param_name_t mnm_fx_ringmod_model_names[] PROGMEM = { {"WAV", 0},
							    {"EXT", 1},
							    {"MIX", 3},
							    {"INP", 7},
							    {"", 127} };

const model_param_name_t mnm_generic_param_names[] PROGMEM = { {"ATK", 0x08 },
							 {"HLD", 0x09 },
							 {"DEC", 0x0a },
							 {"REL", 0x0b },
							 {"DST", 0x0c },
