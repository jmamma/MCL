...
public:
  ...
  // TODO virtual bool isLockEmpty(uint8_t track, uint8_t param);
  virtual bool    isTrigSet(uint8_t track, uint8_t trig) { return isAmpTrigSet(track, trig); }
  ...
  void clearTrig(uint8_t track, uint8_t trig, bool ampTrig,
                 bool filterTrig = false, bool lfoTrig = false,
                 bool triglessTrig = false, bool chordTrig = false);

  void setTrig(uint8_t track, uint8_t trig, bool ampTrig,
               bool filterTrig = false, bool lfoTrig = false,
               bool triglessTrig = false, bool chordTrig = false);

  bool isTrigSet(uint8_t track, uint8_t trig, bool ampTrig,
                 bool filterTrig = false, bool lfoTrig = false,
                 bool triglessTrig = false, bool chordTrig = false);
  ...
  void setAmpTrig(uint8_t track, uint8_t trig) { setTrig(track, trig, true); }
