...
#ifdef SOUND_PAGE
    {"SOUND MANAGER", &sound_browser, 7, 2, 24, 19, nullptr},
#endif
#ifdef WAV_DESIGNER
    {"WAV DESIGNER", &wd.pages[0], 8, 2, 24, 19, nullptr},
#endif
#ifdef LOUDNESS_PAGE
    {"LOUDNESS", &loudness_page, 9, 2, 24, 16, nullptr},
#endif
    {"DELAY", &fx_page_a, 10, 3, 24, 25, nullptr},
    {"REVERB", &fx_page_b, 11, 3, 24, 25, nullptr},
    {"RAM-1", &ram_page_a, 12, 3, 24, 25, nullptr},
    {"RAM-2", &ram_page_b, 13, 3, 24, 25, nullptr},
};
