...
public:
 ...
 void init() {
  ...
  virtual uint16_t get_region() { return *reinterpret_cast<uint16_t*>(BANK1_MD_TRACKS_START); }
  bool is_external() { return get_region() != *reinterpret_cast<uint16_t*>(BANK1_MD_TRACKS_START); }
