...
public:
  ...
  void init();
  void loop();
  void setup_ram_rec(uint8_t track, uint8_t model, uint8_t lev, uint8_t source,
                     uint8_t pan, uint8_t linked_track = 255);
  void setup_ram_rec_mono(uint8_t track, uint8_t lev, uint8_t source);
  void setup_ram_rec_stereo(uint8_t track, uint8_t lev, uint8_t source);
