...
#if !defined(__AVR__)
uint8_t spsx_cache[SPSX_CACHE_LEN];
#endif
#if defined(PLATFORM_TBD)
uint8_t tbd_cache[TBD_CACHE_LEN];
#endif
...
#if !defined(__AVR__)
const uintptr_t BANK1_SPSX_TRACKS_START = reinterpret_cast<uintptr_t>(spsx_cache);
#endif
#if defined(PLATFORM_TBD)
const uintptr_t BANK1_TBD_TRACKS_START = reinterpret_cast<uintptr_t>(tbd_cache);
#endif
