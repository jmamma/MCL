...
constexpr size_t mcl_config_page_N = 4;
...
constexpr size_t gridy_menu_page_N = 2;
constexpr size_t midiport_menu_page_N = 3;
constexpr size_t port1_menu_page_N = 1;
constexpr size_t port2_menu_page_N = 1;
constexpr size_t usbport_menu_page_N = 1;
constexpr size_t midiprogram_menu_page_N = 3;
constexpr size_t midiclock_menu_page_N = 4;
constexpr size_t midiroute_menu_page_N = 3;
constexpr size_t midimachinedrum_menu_page_N = 3;
constexpr size_t midigeneric_menu_page_N = 2;
constexpr size_t midicontrolinput_menu_page_N = 4;
constexpr size_t midicontroloutput_menu_page_N = 3;
constexpr size_t file_menu_page_N = 9;
constexpr size_t seq_menu_page_N = 27;
