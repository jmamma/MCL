...
// Sequencer TX buffer pointers
uint8_t (*seq_tx1_buf)[TX_SEQBUF_SIZE] = (void*)BANK1_UARTSEQ_TX1_BUFFER_START;
uint8_t (*seq_tx2_buf)[TX_SEQBUF_SIZE] = (void*)BANK1_UARTSEQ_TX2_BUFFER_START;
uint8_t (*seq_tx3_buf)[TX_SEQBUF_SIZE] = (void*)BANK1_UARTSEQ_TX3_BUFFER_START;
uint8_t (*seq_tx4_buf)[TX_SEQBUF_SIZE] = (void*)BANK1_UARTSEQ_TX4_BUFFER_START;

// UART1 buffer pointers
uint8_t (*uart1_rx_buf)[UART1_RX_BUFFER_LEN] = (void*)BANK1_UART1_RX_BUFFER_START;
uint8_t (*uart1_tx_buf)[UART1_TX_BUFFER_LEN] = (void*)BANK1_UART1_TX_BUFFER_START;
uint8_t (*uart1_sysex_buf)[SYSEX1_DATA_LEN] = (void*)BANK1_SYSEX1_DATA_START;

// UART2 buffer pointers
uint8_t (*uart2_rx_buf)[UART2_RX_BUFFER_LEN] = (void*)BANK1_UART2_RX_BUFFER_START;
uint8_t (*uart2_tx_buf)[UART2_TX_BUFFER_LEN] = (void*)BANK1_UART2_TX_BUFFER_START;
uint8_t (*uart2_sysex_buf)[SYSEX2_DATA_LEN] = (void*)BANK1_SYSEX2_DATA_START;

// UART USB buffer pointers
uint8_t (*uartusb_rx_buf)[UARTUSB_RX_BUFFER_LEN] = (void*)BANK1_UART0_RX_BUFFER_START;
uint8_t (*uartusb_tx_buf)[UARTUSB_TX_BUFFER_LEN] = (void*)BANK1_UART0_TX_BUFFER_START;
uint8_t (*uartusb_sysex_buf)[SYSEXUSB_DATA_LEN] = (void*)BANK1_SYSEX3_DATA_START;
...
MidiUartUSBClass MidiUartUSB(&UDR0, &uartusb_rx_rb, &uartusb_tx_rb);
