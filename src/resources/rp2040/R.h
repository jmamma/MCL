...
struct __T_menu_options {
  union {
    ...
    char zz__MENU_OPTIONS[1200];
  };
  static constexpr size_t countof_MENU_OPTIONS = 1200 / sizeof(menu_option_t);
  static constexpr size_t sizeofof_MENU_OPTIONS = 1200;
  static constexpr size_t __total_size = 1200;
};
...
struct __T_menu_layouts {
  ...
  union {
    ...
    char zz__port1_menu_layout[56];
  };
  static constexpr size_t countof_port1_menu_layout = 56 / sizeof(menu_t<port1_menu_page_N>);
  static constexpr size_t sizeofof_port1_menu_layout = 56;
  union {
    menu_t<port2_menu_page_N> port2_menu_layout[0];
    char zz__port2_menu_layout[56];
  };
  static constexpr size_t countof_port2_menu_layout = 56 / sizeof(menu_t<port2_menu_page_N>);
  static constexpr size_t sizeofof_port2_menu_layout = 56;
  union {
    menu_t<usbport_menu_page_N> usbport_menu_layout[0];
    char zz__usbport_menu_layout[56];
  };
  static constexpr size_t countof_usbport_menu_layout = 56 / sizeof(menu_t<usbport_menu_page_N>);
  static constexpr size_t sizeofof_usbport_menu_layout = 56;
  union {
  ...
  static constexpr size_t __total_size = 2324;
};
