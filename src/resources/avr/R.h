...
struct __T_menu_options {
  union {
    ...
    char zz__MENU_OPTIONS[1170];
  };
  static constexpr size_t countof_MENU_OPTIONS = 1170 / sizeof(menu_option_t);
  static constexpr size_t sizeofof_MENU_OPTIONS = 1170;
  static constexpr size_t __total_size = 1170;
};
